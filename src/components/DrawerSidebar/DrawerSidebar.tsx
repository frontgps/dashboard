...
import styels from '@/components/DrawerSidebar/DrawerSisebar.module.scss';
import headerStyles from '@/layout/AppHeader.module.scss';
...
export default function DrawerSidebar() {
  ...
  return (
    <>
      <div className={headerStyles['drawer-sider-logo']} onClick={showDrawer}>
        {siderIcon}
      </div>
      <Drawer
        style={{ direction: 'ltr' }}
        title={
          <div className={styels['sider-header']}>
            <img
      ...
      >
        <Menu
          className={styels['menu-container']}
          items={items}
          selectedKeys={[location.pathname]}
        />
        <div className={styels['documant-container']}>
          <div>
